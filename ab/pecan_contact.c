                                 ...
                                 const gchar *name)
{
    ...
    if (purple_account_get_bool_without_default_value (contact->contactlist->session->account, "hide_msgplus_tags"))
    {
        char* parsed_name;
                                    ...
                                    const gchar *value)
{
    ...
    if (value && purple_account_get_bool_without_default_value (contact->contactlist->session->account, "hide_msgplus_tags"))
    {
        char* parsed_value;
